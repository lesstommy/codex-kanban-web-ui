...
The integration suite uses a real local `codex app-server`; it does not use a fake runner. Tests that start Codex therefore require a working Codex installation, a signed-in account, network access, and may consume account usage.
